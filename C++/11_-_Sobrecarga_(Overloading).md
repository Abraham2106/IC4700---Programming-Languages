# Sobrecarga (Overloading) — Resolución de sobrecarga y name mangling en tiempo de compilación

La sobrecarga permite declarar múltiples funciones con el mismo nombre pero diferentes firmas, resuelta en tiempo de compilación mediante name mangling. Este mecanismo facilita la extensibilidad sintáctica pero requiere reglas precisas de resolución para evitar ambigüedades.
...
### 3.1 Name Mangling (Decoración de nombres)
...
## 4. Teoría: Firmas y Name Mangling

### 4.1 1. ¿Qué constituye una sobrecarga válida?
...
### 4.2 2. Sobrecarga por const correctness
...
### 5.1 Nivel Simple: Sobrecarga básica
```cpp
int sumar(int a, int b) { return a + b; }
double sumar(double a, double b) { return a + b; }
```

### 5.2 Nivel Aplicado: Funciones con argumentos por defecto
...
### 5.3 Nivel Complejo: Sobrecarga por calificación Ref (Ref-Qualifiers) - C++11
...
### Exercise 1 — Sobrecarga y Ambigüedad de Tipos
...
*Next: `12 — Herencia y Visibilidad.md` — Acceso public, protected y private en herencia.*
